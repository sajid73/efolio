...
const FooterComp = () => {
    const d = new Date();
    return (
        <footer class="bg-white text-center mt-5">
            <div class="container py-5">
                <div class="row py-3">
                    ...
                    <div class="col-lg-4 col-md-6 mb-lg-0">
                        <h6 class="text-uppercase font-weight-bold mb-4">Efolio</h6>
            ...
            <div class="bg-light py-2">
                <div class="container text-center">
                    <p class="text-muted mb-0 py-2">&copy; {d.getFullYear()} Easyfie All risghts reserved.</p>
